...
\afterpage{
    \begin{figure}[t!]
        \centering
        \includegraphics[scale = 0.18]{03_Chapter-2/00A_Figures/Figure_Distribution-of-HDDs.png}
        \caption{Distribution of Daily Heating Degree Days during Experiment Periods}
        \caption*{
            {\small
            \textit{Note}: This histogram shows the distribution of daily HDDs, with the mean and median values, in each experiment period. Only the second halves of 2009 and 2010 are utilized to generate the histogram. 
        }}
