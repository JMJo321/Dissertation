...
\afterpage{
    \begin{figure}[t!]
        ...
        \subcaption*{\textit{Note}: This figure shows time profiles of hourly treatment effects measured by setting Tariff Groups A and D as the control and treatment groups. Each row in the figure corresponds to one of the three indicator variables of interest. The time profiles suggest only limited evidence of load-shifting. }
