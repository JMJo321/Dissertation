...
\afterpage{
     \begin{figure}[t!]
         \centering
         \includegraphics[scale = 0.115]{04_Chapter-3/00A_Figures/Figure_Completion-over-Time.png}
...
%\afterpage{
    \begin{figure}[t!]
        \centering
        \includegraphics[scale = 0.12]{04_Chapter-3/00A_Figures/Figure_Cross-Sectional-Approach_Estimates-from-Robinson-Estimator_Spatial-Distribution-of-Unobservable-Geological-Quality.png}
...
\afterpage{
    \begin{figure}[t!]
        \centering
        \includegraphics[scale = 0.14]{04_Chapter-3/00A_Figures/Figure_Cross-Sectional-Approach_Estimates-from-Robinson-Estimator_Time-Trend-of-Unobservable-Geological-Quality.png}
...
\afterpage{
    \begin{figure}[t!]
        \centering
        \includegraphics[scale = 0.115]{04_Chapter-3/00A_Figures/Figure_Cross-Sectional-Approach_Estimates-from-Robinson-Estimator_Time-Trend-of-Unobservable-Geological-Quality_Firms.png}
...
\afterpage{
    \begin{figure}[t!]
        \centering
        \includegraphics[scale = 0.20]{04_Chapter-3/00A_Figures/Figure_Equilibrium-Path_Endogenous-Price_Phase-Diagram_pi-by-R.png}
        \includegraphics[scale = 0.20]{04_Chapter-3/00A_Figures/Figure_Equilibrium-Path_Endogenous-Price_Phase-Diagram_Pr-by-R.png}
...
\afterpage{
    \begin{figure}[t!]
        \centering
        \includegraphics[scale = 0.15]{04_Chapter-3/00A_Figures/Figure_Impact-of-Demand-Shocks-on-Drilling-of-Well-Sites-with-Heterogeneous-Quality}
