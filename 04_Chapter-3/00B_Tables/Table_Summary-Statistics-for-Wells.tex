    ...
    \begin{table}
        ...
        \begin{adjustbox}{scale = 0.75}
            \begin{tabular}{
                ...
                >{\raggedleft}m{2.4cm}
                >{\raggedleft}m{2.4cm}
                >{\raggedleft\arraybackslash}m{2.4cm}
            }
                \hline \hline
                ...
                \underline{Drilling} &  &  &  &  &  \\
                \hspace{0.2cm} Water \ (Bbls) & 101,716.50 & (249,157.50) & 42,032.75 & 65,856.00 & 130,219.20 \\
                \hspace{0.2cm} Sand/Proppants \ (Lbs) & 4,553,380.00 & (4,560,985.00) & 2,312,951.00 & 3,441,914.00 & 5,543,660.00 \\
        ...
        \begin{minipage}{15.5cm}
            \small \singlespacing
            \textit{Note}: This table presents summary statistics for 694,294 horizontal wells whose cumulative production month equals or exceeds 24. 
        \end{minipage}
    \end{table}
}
